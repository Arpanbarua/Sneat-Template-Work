...
@section('backend_content')
    ...
    <div class="card-body">
        <form action="{{ route('dashboard.category.update', $edit_category->id) }}" method="post"
            ...
            <div class="row align-items-center mb-2">
                <div class="col-lg-6 mb-2">
                    ...
                    <input type="text" name="title" id="title" class="form-control mt-2 mb-3 p-3"
                        value="{{ $edit_category->title }}" placeholder="title">
                    @error('title')
                    ...
                    <select class="js-example-basic-single form-select p-2 " name="category" id="category">
                        ...
                        @foreach ($allCategory as $category)
                            {{-- @if ($category->id != $edit_category->id)
                                <option {{ $category->id == $edit_category->parent_id ? 'selected' : '' }}
                                    value="{{ $category->id }}">
                                    {{ $category->title }}
                                </option>
                                @endif --}}
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="m_title" id="m_title" class="form-control p-3 mt-2"
                            value="{{ $edit_category->meta_title }}" placeholder="Meta Title">
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <textarea name="m_desc" id="" cols="3" rows="2" class="form-control mt-1"
                            placeholder="Write Meta Description Here">{{ $edit_category->meta_description }}</textarea>
                    </div>
                ...
                <div class="row align-items-end g-2">
                    ...
                    <div class="col-lg-6 mt-3">
                        <img src="{{ $edit_category->image ? asset('/storage/category/' . $edit_category->image) : asset('assets/placeholder_image.jpg') }}"
                            alt="placeholder image" width="100px">
                    </div>
                </div>
